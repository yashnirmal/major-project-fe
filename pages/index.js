        ...
        <div className="bg-gradient-to-r from-gray-500 to-gray-700">
          <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
            ...
            <p className="mt-4 max-w-3xl text-lg text-purple-200">
              Invest with Confidence, Harvest with Certainty: Our Guarantee
              Ensures Purely Organic Farms. Bridging Investors to Organic Farms,
              Backed by Our Unwavering Guarantee.
            </p>
